...
/*
 adminController.setContactToClientDate = function (req, res, next) {
 if (req.body['contactToClientDate'] !== undefined) {
 models.sample.getByIdPopulated(req, res, next, req.params.id, function (req, res, next, sample) {
 if (!sample) {
 var error = new Error('Not found');
 error.status = 404;
 ...
 var sampleSet = {
 contactToClientDate: req.body['contactToClientDate']
 };
 models.sample.updateById(req, res, next, sample._id, sampleSet, function (req, res, next, sample) {
 ...
 adminController.setClientRepliedDate = function (req, res, next) {
 if (req.body['clientRepliedDate'] !== undefined) {
 models.sample.getByIdPopulated(req, res, next, req.params.id, function (req, res, next, sample) {
 if (!sample) {
 var error = new Error('Not found');
 error.status = 404;
 ...
 var sampleSet = {
 clientRepliedDate: req.body['clientRepliedDate']
 };
 models.sample.updateById(req, res, next, sample._id, sampleSet, function (req, res, next, sample) {
 req.flash('success', 'Saved');
 return res.redirect(req.header('Referer'));
 ...
 adminController.setComments = function (req, res, next) {
 console.log(req);
 ...
 adminController.setCalls = function (req, res, next) {
 console.log(req);
 ...
 var sampleSet = {};
 if (req.body['call'] == 1) {
 sampleSet.call1st = req.body['call1st'] ? true : false;
 } else if (req.body['call'] == 2) {
 sampleSet.call2nd = req.body['call2nd'] ? true : false;
 } else if (req.body['call'] == 3) {
 sampleSet.call3rd = req.body['call3rd'] ? true : false;
 }
 models.sample.updateById(req, res, next, sample._id, sampleSet, function (req, res, next, sample) {
 req.flash('success', 'Saved');
 return res.redirect(req.header('Referer'));
